...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bulletList: Schema.Attribute.Component<
      'page-components.mission-features',
      true
    > &
    ...
    licenseItem: Schema.Attribute.Component<'page-components.licenses', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    publishedAt: Schema.Attribute.DateTime;
    timelineItem: Schema.Attribute.Component<'page-components.history', true> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCountryCountry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    cost_of_living: Schema.Attribute.Component<
      'country-components.cost-of-living-item',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    universities: Schema.Attribute.Relation<
      'manyToMany',
      'api::partner-university.partner-university'
    >;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    visa_info: Schema.Attribute.Component<
      'country-components.visa-info-item',
      true
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
...
export interface ApiHomePageStatHomePageStat extends Struct.SingleTypeSchema {
  collectionName: 'home_page_stats';
  info: {
    displayName: 'Home Page Stats';
    pluralName: 'home-page-stats';
    singularName: 'home-page-stat';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    countriesCount: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    countriesLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-page-stat.home-page-stat'
    >;
    publishedAt: Schema.Attribute.DateTime;
    StudentsCount: Schema.Attribute.Integer &
      Schema.Attribute.SetPluginOptions<{
    ...
    studentsLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    successRate: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    universitiesLabel: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiPartnerUniversityPartnerUniversity
  extends Struct.CollectionTypeSchema {
  collectionName: 'partner_universities';
  info: {
    displayName: 'PartnerUniversity';
    pluralName: 'partner-universities';
    singularName: 'partner-university';
  };
  options: {
    draftAndPublish: true;
  };
  ...
  attributes: {
    ...
    programsCount: Schema.Attribute.String &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-page-stat.home-page-stat': ApiHomePageStatHomePageStat;
      'api::legal-page.legal-page': ApiLegalPageLegalPage;
      'api::partner-university.partner-university': ApiPartnerUniversityPartnerUniversity;
